...
```{r prior_proc, results='asis', echo=FALSE, warning=FALSE, message=FALSE}
	...
	create_clustering <- function(target, all_metrics, metrics_to_process, count_data){
		...
		traitColors = numbers2colors(samples_metrics_corrected, signed = FALSE)

		plotDendroAndColors(sampleTree, traitColors,
		                      groupLabels = names(samples_metrics_corrected),
...
save.image("/mnt/home/users/bio_267_uma/josecordoba/proyectos/aurora_omicas/analysis/mRNAseq/DEG_workflow/test.RData")
...
#############
	...
	plot_in_div(create_clustering(target_obj, metric_table, vars_clustering, count_data),
				fig_height=(7 + 0.2 * length(vars_clustering)), 
				fig_width=calc_width_samples(sample_counts))
	"
