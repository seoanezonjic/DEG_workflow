...
```{r prior_proc, echo=FALSE, warning=FALSE, message=FALSE}
	...
	metric_var_2_legend_name <- data.frame(
		metric_var = c("initial_total_sequences", "final_total_sequences", "Uniquely_mapped_reads_.", "X._of_reads_mapped_to_multiple_loci", "X._of_reads_mapped_to_too_many_loci", "X._of_reads_unmapped._too_short", "X._of_reads_unmapped._other", "Uniquely_mapped_reads_number", "aligned_to_feature", "initial_weigthed_qual_per_sequence", "number_duplicatedreads.estimated.", "final_mean_qual_per_base", "final_min_qual_per_base_in_10th_decile", "final_weigthed_qual_per_sequence"),
		legend_name = c("Total Reads Before Trimming", "Total Reads After Trimming", "Unique Map %", "Multi Map %", "Multi Map-too many %", "Too Short %", "Other %", "Unique Map", "Aligned to Genomic Feature", "Weighted Sequence Quality Before Trimming", "Estimated Duplicated Reads", "Average Base Quality", "Min Qual per Base (Tenth Decile)", "Weighted Sequence Quality")
	)
...
```{r qual_scores, echo=FALSE, warning=FALSE, message=FALSE}
	vars_perc_aligned <- c("final_min_qual_per_base_in_10th_decile", "final_mean_qual_per_base", "final_weigthed_qual_per_sequence")
