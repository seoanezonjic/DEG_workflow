...
```{r mirna_mapping, results='asis', echo=FALSE, warning=FALSE, message=FALSE, eval=vars_mirna_mapping}
	##################################################
	###	miRNASEQ PLOTS
	##################################################
	...
	#mirna_mapping_metric_table <- sapply(mirna_mapping_metric_table, function(x) as.numeric(gsub("\\%", "", x)))
	mirna_mapping_metric_table <- data.frame(metric_table["sample"], mirna_mapping_metric_table)
	# Sum multimapping
	# mirna_mapping_metric_table[, "multi_map"] <- mirna_mapping_metric_table[,"X._of_reads_mapped_to_multiple_loci"] + mirna_mapping_metric_table[,"X._of_reads_mapped_to_too_many_loci"]
	# Reselect table
	# vars_mirna_mapping <- c("Uniquely_mapped_reads_.", "multi_map", "X._of_reads_unmapped._too_short", "X._of_reads_unmapped._other")
	# mirna_mapping_metric_table <- mirna_mapping_metric_table[, vars_mirna_mapping]
	# mirna_mapping_metric_table <- data.frame(metric_table["sample"], mirna_mapping_metric_table)
