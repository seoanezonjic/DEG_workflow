...
do
	...
	echo functional_Hunter.R $functional_hunter_options -i $target_results_folder -t E -o $target_results_folder/functional_enrichment > $target_results_folder/'functional_Hunter.log'
