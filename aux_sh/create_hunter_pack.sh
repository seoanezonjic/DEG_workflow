...
do
    ...
    add_annotation.R -i $comparison_path/filtered_count_data.txt -o $out_comparison/filtered_count_data.txt $mode_annot $gene_id -K SYMBOL -O $fun_organism
    add_annotation.R -i $comparison_path/final_counts.txt -o $out_comparison/final_counts.txt $mode_annot $gene_id -K SYMBOL -O $fun_organism
