...
sampleNames=('wt23_11' 'wt7_4' 'KI7_5' 'wt7_2') #wt7_2 = control in PCA BEFORE DEA
for i in "${sampleNames[@]}"
do
	mkdir -p blastn_results/$i"_results"
	unm_path="/mnt/scratch/users/bio_267_uma/elenarojano/NGS_projects/EURAS/results/clean_and_map/$i/qualimap_0000"
