...
all_report_files=$report_folder/metric_table,$report_folder/all_counts
if [ "$TARGETS" != "" ]; then
...
if [[ $experiment_type == "miRNAseq_detection" ]]; then
	...
	cat $MAPPING_RESULTS_FOLDER/*/miRDeep2.pl_0000/known_miRNAs.translation | sort -u > $mapping_ref'/known_miRNAs.translation'
